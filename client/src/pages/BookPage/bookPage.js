...
export const BookNow = () => {
  ...
  const fetchBookingDetails = async () => {
    try {
      const response = await axios.get('http://swe-project-m48k.onrender.com/authentication/profile');
  ...
  const handleSubmit = async () => {
    try {
      const response = await axios.post('http://swe-project-m48k.onrender.com/roombook/bookRoom', {
        studentName: studentName,
        studentEmail: studentEmail,
        guestName: guestName,
        numberOfGuests: numberOfGuests,
